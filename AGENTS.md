...
- The All Downloads page uses bounded newest-first history loading (30 initially, then 100 more), with server-side status filtering and exact qBittorrent completion timestamps for new downloads.
