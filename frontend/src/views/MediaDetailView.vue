  ...
  <div>
    ...
    <div v-else-if="item">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div v-if="metadata" class="hidden md:flex flex-wrap gap-3 mb-6">
            ...
            <div class="inline-flex items-center gap-3 px-4 py-3 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
              ...
              >
                View on {{ metadata.source.toUpperCase() }} <ExternalLink class="w-3 h-3 inline-block ml-1" />
              </a>
            </div>
            <!-- IMDb card -->
            <div
      ...
      <div class="hidden md:block mt-8">
        ...
        >
          <ChevronRight class="w-3 h-3 text-gray-500 transition-transform duration-200" :class="{ 'rotate-90': filesExpanded }" />
