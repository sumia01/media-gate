CREATE TABLE "media_requests_old" (
...
INSERT INTO "media_requests_old" (
...
FROM "media_requests"
WHERE "scope" IN ('media', 'season', 'episode');

DROP TABLE "media_requests";
ALTER TABLE "media_requests_old" RENAME TO "media_requests";
